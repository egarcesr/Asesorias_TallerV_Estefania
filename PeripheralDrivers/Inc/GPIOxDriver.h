...
typedef struct
{
	...
	uint8_t GPIO_PinPuPdControl;				// Seleccionamos si deseamos una salidad Pull_up, Pull_down o "libre"
...
/* Esta es una estructura contiene dos elementos:
 * - La dirección del puerto que se está utilizando (la referencia al puerto)
 * - La configuración especçifica del PIN que se está utilizando
 */
...
/* Definicón de los nombres de los pines */
#define PIN_0					0
#define PIN_1					1
#define PIN_2					2
#define PIN_3					3
