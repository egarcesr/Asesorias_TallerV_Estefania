...
void BasicTimer_Config(BasicTimer_Handler_t *ptrBTimerHandler){
	...
	// -1 porqué el contador empieza en cero
	...
	if(ptrBTimerHandler -> TIMx_Config.TIMx_mode == BTIMER_MODE_UP){
		...
		// Necesitamos poner dirección en cero para que cuente hacia arriba
		ptrBTimerHandler -> ptrTIMx -> CR1 &= ~TIM_CR1_DIR;

		/* 3b. Configuramos el Auto-reload. Este es el "limite" hasta donde el CNT va a contar */
		ptrBTimerHandler -> ptrTIMx -> ARR = ptrBTimerHandler->TIMx_Config.TIMx_period - 1;

		/* 3c. Reiniciamos el registro counter para que empiece a contar en cero*/
		...
		/* 3b. Configuramos el Auto-reload. Este es el "limite" hasta donde el CNT va a contar
		 * En modo descendente, con numero positivos, cual es el minímo valor al que ARR puede llegar*/
...
void GPIOxTooglePin (GPIO_Handler_t *pPinHandler){
	...
	// Accede al registro ODR Output Data Register y lee el valor lógico ocupa esa posición. Se trabaja con el registro ODR
	// porqué este se puede tanto escribir como leer y la operación XOR con 1 garantiza que sin importar el valor que tenga
	// el bit el cambie de estado.
